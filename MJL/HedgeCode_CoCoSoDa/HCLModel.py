...
class HCLModel(nn.Module):
    def __init__(self, encoder, args, tokenizer, hidden_size):
        ...
        if self.training and encoder.training:
            ...
            self.register_buffer("queue", torch.randn(768, self.K))  # [768*B]
    ...
    def forward(self, input_ids):
        if self.training:
            ...
            pos_outputs = self.encoder(pos_inputs_ids, attention_mask=input_ids["attention_mask"]).last_hidden_state  # [B*len*768]
